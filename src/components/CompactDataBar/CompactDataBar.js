                        ...
                        <main className="align-items-center d-flex h-100 w-100">
                            <Row className="h-75 m-0 p-0 row w-100">
                                ...
                                <section className="h-100 px-xl-2 px-lg-2 bg-white rounded w-auto d-inline-block">
                                    ...
                                    <article className="px-xl-2 px-lg-2 bg-white rounded w-auto d-inline-block">
                                ...
                                <section className="h-100 px-xl-2 px-lg-2 d-inline-block d-flex flex-grow-1 justify-content-space-around d-inline-block">
                                    <div className="bg-white d-inline-block rounded mx-1 w-auto py-2 px-lg-2 px-md-1 px-xl-4 max-w-18">
                                        <p className="font-aggegate-main-text m-0 text-left text-black m-0">
                                            <FontAwesomeIcon className="font-size-small vertical-initial text-red" icon={faArrowUp} />
                                            25D
                                                </p>
                                        <p className="font-aggegate-sub-text m-0 text-left text-black-50 m-0">
                                    ...
                                    <div className="bg-white d-inline-block rounded mx-1 w-auto py-2 px-lg-2 px-md-1 px-xl-4 max-w-18">
                                        <p className="font-aggegate-main-text m-0 text-left text-black m-0">
                                            <FontAwesomeIcon className="font-size-small vertical-initial text-orange" icon={faCircle} /> 35D
                                                </p>
                                        <p className="font-aggegate-sub-text m-0 text-left text-black-50 m-0">
                                    ...
                                    <div className="bg-white d-inline-block rounded mx-1 w-auto py-2 px-lg-2 px-md-1 px-xl-4 max-w-18">
                                        <p className="font-aggegate-main-text m-0 text-left text-black m-0">
                                            <FontAwesomeIcon className="font-size-small vertical-initial text-green" icon={faArrowDown} />
                                            2D
                                                </p>
                                        <p className="font-aggegate-sub-text m-0 text-left text-black-50 m-0">
                                            <small>Av MTTD</small>
                                    ...
                                    <div className="bg-white d-inline-block rounded mx-1 w-auto py-2 px-lg-2 px-md-1 px-xl-4 max-w-18">
                                        <p className="font-aggegate-main-text m-0 text-left text-black m-0">
                                            <FontAwesomeIcon className="font-size-small vertical-initial text-red" icon={faArrowDown} />
                                            6D
                                                </p>
                                        <p className="font-aggegate-sub-text m-0 text-left text-black-50 m-0">
                                            <small>Av MTTR</small>
                                    ...
                                    <div className="bg-white d-inline-block rounded mx-1 w-auto py-2 px-lg-2 px-md-1 px-xl-4 max-w-18">
                                        <p className="font-aggegate-main-text m-0 text-left text-black m-0">
                                            <FontAwesomeIcon className="font-size-small vertical-initial text-orange" icon={faCircle} />  8
                                                </p>
                                        <p className="font-aggegate-sub-text m-0 text-left text-black-50 m-0">
